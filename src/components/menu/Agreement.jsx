...
const Agreement = () => {
  return (
    <div className='w-full h-full py-5 px-7 flex flex-col gap-4 border-b border-gray-200'>
        <h1 className='text-[0.682rem] sm:text-[0.912rem] font-semibold'>Investing involves risk. There is always the potential of losing money when you invest in securities. Asset allocation, diversification, and rebalancing do not ensure a profit or protect against loss in declining markets.</h1>
        <div>
            <p className='flex flex-col gap-4 text-[0.682rem] sm:text-[0.912rem]'>
                ...
                <span>Merrill offers a broad range of brokerage, investment advisory (including financial planning) and other services. Additional information is available in our Client Relationship Summary.</span>
