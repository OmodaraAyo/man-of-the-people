  ...
  return (
    <header className="min-h-screen flex flex-col">
      <main className="flex-grow pt-40">
        ...
        {showWarning && (
            <div className="w-full h-full bg-[#ffefbc] flex justify-around py-5 container mx-auto sm:max-w-[32rem] mt-0.5 rounded">
            <div className="flex gap-2 max-w-[17rem] text-[1.02rem] font-semibold">
              ...
              <button className="text-[0.869rem] text-blue-700">View Payment Details</button>
              </div>
            </div>
            <IoCloseSharp size={25} color="gray" onClick={() => setShowWarning(false)} className="cursor-pointer active:text-gray-600"/>
          </div>
        )}
        <div className="flex flex-col gap-4 w-full items-center bg-gray-200 mt-4 py-5 px-11">
